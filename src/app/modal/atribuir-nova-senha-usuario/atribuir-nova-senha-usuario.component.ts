...
@Component({
  selector: 'app-atribuir-nova-senha-usuario',
  templateUrl: './atribuir-nova-senha-usuario.component.html',
  styleUrls: ['./atribuir-nova-senha-usuario.component.css']
})
export class AtribuirNovaSenhaUsuarioComponent implements OnInit {
